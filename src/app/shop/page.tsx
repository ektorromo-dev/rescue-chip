                ...
                <section>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: "20px" }}>
                        ...
                        <div style={{ backgroundColor: "#1A1A18", borderRadius: "16px", padding: "24px", border: "1px solid rgba(255,255,255,0.08)", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                            ...
                            <Link href={getWhatsAppLink("Starter")} target="_blank" style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center", height: "44px", borderRadius: "12px", fontWeight: 700, fontSize: "14px", backgroundColor: "transparent", color: "#F4F0EB", border: "1px solid rgba(255,255,255,0.15)" }}>
                                Solicitar
                            </Link>
                        </div>
                        ...
                        <div style={{ backgroundColor: "#1A1A18", borderRadius: "16px", padding: "24px", border: "1px solid rgba(232,35,26,0.40)", display: "flex", flexDirection: "column", justifyContent: "space-between", position: "relative" }}>
                            ...
                            <Link href={getWhatsAppLink("Growth")} target="_blank" style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center", height: "44px", borderRadius: "12px", fontWeight: 900, fontSize: "14px", backgroundColor: "#E8231A", color: "#FFF", border: "none" }}>
                                Solicitar
                            </Link>
                        </div>
                        ...
                        <div style={{ backgroundColor: "#1A1A18", borderRadius: "16px", padding: "24px", border: "1px solid rgba(255,255,255,0.08)", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                            ...
                            <Link href={getWhatsAppLink("Premium")} target="_blank" style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center", height: "44px", borderRadius: "12px", fontWeight: 700, fontSize: "14px", backgroundColor: "transparent", color: "#F4F0EB", border: "1px solid rgba(255,255,255,0.15)" }}>
                                Contáctanos
                            </Link>
                        </div>
