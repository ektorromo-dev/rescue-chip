          ...
          RescueChip · rescue-chip.com
            ...
            <div style={{ marginTop: "48px", borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: "24px", textAlign: "center", padding: "24px 16px" }}>
                <p style={{ fontSize: "11px", color: "#6A6763", lineHeight: 1.6, maxWidth: "380px", margin: "0 auto" }}>
                    <strong style={{ color: "#9E9A95" }}>RESCUECHIP</strong> es un sistema de identificación prehospitalaria de emergencia. No sustituye servicios de emergencia. Llame al <strong style={{ color: "#E8231A", fontSize: "12px" }}>911</strong> ante cualquier emergencia. La información mostrada fue proporcionada por el usuario y puede no estar actualizada.{" "}
